...
1. Run affected utility regression tests and the local Markdown link check after changes to templates, scripts, or layout guidance; review changed instructions against real project evidence.
